...
func secret_test (w http.ResponseWriter, r *http.Request) {
	...
	//после проверки сессии как узначть что это за пользователь ?
...
func login(w http.ResponseWriter, r *http.Request) {
	session, _ := store.Get(r, "cookie-name")
	// якобы авторизация проверка логина и пароля 
	// ...
...
func logout(w http.ResponseWriter, r *http.Request) {
	...
	session.Save(r, w)
		...
		func main() {
			...
			http.HandleFunc("/secret_test/", secret_test)
